...
| -------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Element Interaction**    |                                                                                                                                                                                                                                                                                                                                |
| **- Input Actions**        | `addValue`, `clearValue`, `setValue`                                                                                                                                                                                                                                                                                           |
| **- Click/Select Actions** | `click`, `doubleClick`, `dragAndDrop`, `selectByAttribute`, `selectByIndex`, `selectByVisibleText`, `touchAction`                                                                                                                                                                                                              |
| **- Element Retrieval**    | `$$`, `$`, `getAttribute`, `getCSSProperty`, `getComputedLabel`, `getComputedRole`, `getHTML`, `getLocation`, `getProperty`, `getSize`, `getTagName`, `getText`, `getValue`, `getElement`, `getElements`, `shadow$$`, `shadow$`, `nextElement`, `parentElement`, `previousElement`, `custom$$`, `custom$`, `react$$`, `react$` |
| **- State Checking**       | `isClickable`, `isDisplayed`, `isEnabled`, `isExisting`, `isFocused`, `isSelected`, `isStable`, `isEqual`                                                                                                                                                                                                                      |
| **- Scrolling/Moving**     | `scrollIntoView`, `moveTo`, `dragAndDrop`, `touchAction`                                                                                                                                                                                                                                                                       |
| **- Waiting**              | `waitForClickable`, `waitForDisplayed`, `waitForEnabled`, `waitForExist`, `waitForStable`, `waitUntil`                                                                                                                                                                                                                         |
| **- Screenshot & Saving**  | `saveScreenshot`                                                                                                                                                                                                                                                                                                               |
| **Custom Selectors**       | `custom$$`, `custom$`, `react$$`, `react$`                                                                                                                                                                                                                                                                                     |
| **JavaScript Execution**   | `execute`, `executeAsync`                                                                                                                                                                                                                                                                                                      |
| **Screenshot & Saving**    | `saveScreenshot`, `savePDF`, `saveRecordingScreen`                                                                                                                                                                                                                                                                             |
| **Window & Session**       | `getWindowSize`, `newWindow`, `reloadSession`, `switchWindow`, `setWindowSize`, `setViewport`                                                                                                                                                                                                                                  |
| **Cookie Management**      | `getCookies`, `setCookies`, `deleteCookies`                                                                                                                                                                                                                                                                                    |
| **Mocking & Debugging**    | `mock`, `mockClearAll`, `mockRestoreAll`, `debug`                                                                                                                                                                                                                                                                              |
| **Throttle & Emulation**   | `throttle`, `throttleCPU`, `throttleNetwork`, `emulate`                                                                                                                                                                                                                                                                        |
| **Wait & Pause**           | `waitUntil`, `pause`                                                                                                                                                                                                                                                                                                           |
| **Navigation**             | `url`, `call`, `uploadFile`, `downloadFile`, `restore`                                                                                                                                                                                                                                                                         |
| **Command Modification**   | `addCommand`, `overwriteCommand`                                                                                                                                                                                                                                                                                               |
| **Puppeteer Integration**  | `getPuppeteer`                                                                                                                                                                                                                                                                                                                 |
| **Miscellaneous**          | `addInitScript`, `keys`, `scroll`, `setTimeout`                                                                                                                                                                                                                                                                                |

- [Reference Notes](Web-interactions.md)
- For More details visit [Official Documentation](https://webdriver.io/docs/api/)

# Issues with async and await

[Reference](lssuesForAsync.md)
